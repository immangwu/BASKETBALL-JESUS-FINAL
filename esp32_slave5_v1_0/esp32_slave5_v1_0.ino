/*
  ╔══════════════════════════════════════════════════════════════╗
  ║  Slave 5  v1.0  —  Fouls Team A  TOP row                    ║
  ║  Hardware : 2 × P10 panels in one row  →  64 × 16 px        ║
  ╠══════════════════════════════════════════════════════════════╣
  ║  Layout (combined with Slave 6):                            ║
  ║   ┌──────────────────────────────────────┐                  ║
  ║   │FA  ┌──────────────────────────────┐  │  ← Slave 5 TOP  ║
  ║   │    │   TOP HALF of foul digit     │  │    (this file)   ║
  ║   └────┴──────────────────────────────┴──┘                  ║
  ║   ┌────┬──────────────────────────────┬──┐                  ║
  ║   │    │  BOTTOM HALF of foul digit   │  │  ← Slave 6 BOT  ║
  ║   └────┴──────────────────────────────┴──┘                  ║
  ║                                                              ║
  ║  "FA" label : size 1 (6×8 px), top-left corner             ║
  ║  Foul digit : size 3 (18×24 px), cursor y=0                ║
  ║               top 16 px visible here, bottom 8 px Slave 6  ║
  ║                                                              ║
  ║  COLOR                                                       ║
  ║    foulsA < 5  →  GREEN                                     ║
...
void setup() {
    ...
    if (esp_now_init() != ESP_OK) {
        ...
        Serial.println("Slave 5 v1.0 ready — 64x16 Fouls-A top row");
    }
}
