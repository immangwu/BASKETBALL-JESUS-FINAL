...
from PyQt5.QtWidgets import (
    ...
    QGridLayout, QScrollArea, QMessageBox, QSplashScreen
)
...
def main():
    ...
    if os.path.exists(logo_path):
        ...
        # Fallback: white "PointiQ" text centered
        p.setPen(QColor("#ffffff"))
        p.setFont(QFont("Segoe UI", 72, QFont.Bold))
        p.drawText(pix.rect(), Qt.AlignCenter, "PointiQ")
